...
public class Search extends JPanel {
    ...
    public Color pinkColor  = new Color(133, 149, 246);
    ...
    public void adding(int ind,int val){
        arr[ind] = val;
        Update();
    }
    ...
    public void paintComponent(Graphics g){
        ...
        graphics.setColor(new Color(137, 100, 231));              //BG color
        ...
        for (int i = 0; i<arrSize; i++){
            ...
            if (arrayColor[i] == pinkColor){
                graphics.setColor(new Color(229, 209, 84));
