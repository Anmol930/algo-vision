...
public class ArrayScreen extends JPanel{
    ...
    JButton startBtn, resetBtn, bottomBtn,sizeBtn;
    JComboBox<String> actiontypeBox;
    JTextField input, indexInput,sizeIp;
    JLabel indexinputtext, speedText, dateinputtext, actiontext,sizeText;
    ...
    public ArrayScreen(){
        ...
        sizeText.setBounds(10, 40, 140, 25);
        sizeText.setFont(new Font(mainFont, Font.PLAIN, 12));
        sizeText.setForeground(Color.white);

        sizeIp = new JTextField(Integer.toString(sizeVal));
        sizeIp.setBorder(BorderFactory.createLineBorder(Color.white));
        sizeIp.setBounds(120, 40, 90, 25);
        sizeIp.setBackground(new Color(102,102,102));
        sizeIp.setForeground(Color.white);
        sizeIp.setFont(new Font(mainFont, Font.BOLD, 15));




        sizeBtn = new JButton("Generate Array");
        sizeBtn.setBounds(40, 80, 150,25);
        sizeBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                arraySize = Integer.parseInt(sizeIp.getText());
                ResetArray(arraySize);

            }
        });
        sizeBtn.setBackground(themeColor);
        sizeBtn.setFont(new Font(mainFont, Font.BOLD, 15));
        sizeBtn.setForeground(Color.white);
        sizeBtn.setFocusable(false);
        sizeBtn.setBorder(null);
        sizeBtn.setVisible(true);
        //When the button is hovered
        sizeBtn.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent evt) {
                if (sizeBtn.isEnabled())
                    sizeBtn.setBackground(themeColor.darker());
            }
        ...
        resetBtn.setBounds(40, pos, 150,25);
        ...
        actiontypeBox.setBounds(40, pos, 150, 25);
        ...
        dateinputtext.setBounds(40, pos, 240, 50);
    ...
    public void paintComponent(Graphics g){
        ...
        graphics.setColor(new Color(128, 79, 138));              //BG color
        ...
        for (int i = 0; i<arraySize; i++){
            ...
            graphics.setColor(Color.white);
            graphics.drawString("Index: " , 50, (HEIGHT/2)-65);
            graphics.drawString(Integer.toString(i), pos+8, (HEIGHT/2)-20);
