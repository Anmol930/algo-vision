...
public class PriorityQueueMin extends JPanel {
    ...
    public PriorityQueueMin(){
        ...
        pos += 60;
        hintText = new JLabel("<html>Note:-number <br> must be of same length<br> i.e make all <br> numbers equal <br> by adding zero <br> as prefix. </html>");
        hintText.setBounds(40, pos, 280, 200);
